...
void* uniffi_rustpushgo_fn_method_client_lookup_targets_once(
	void* ptr,
	RustBuffer targets,
	RustBuffer handle,
	RustCallStatus* out_status
...
void* uniffi_rustpushgo_fn_method_client_send_leave_group(
	void* ptr,
	RustBuffer conversation,
	uint64_t group_version,
	RustBuffer handle,
...
void* uniffi_rustpushgo_fn_method_client_send_multipart_message(
	void* ptr,
	RustBuffer conversation,
	RustBuffer parts,
	RustBuffer handle,
...
void* uniffi_rustpushgo_fn_method_client_validate_targets_http(
	void* ptr,
	RustBuffer targets,
	RustBuffer handle,
	RustCallStatus* out_status
...
void* uniffi_rustpushgo_fn_method_loginsession_request_sms_2fa(
	void* ptr,
	uint32_t phone_id,
	RustCallStatus* out_status
);
...
RustBuffer uniffi_rustpushgo_fn_method_loginsession_two_factor_kind(
	void* ptr,
	RustCallStatus* out_status
);

void* uniffi_rustpushgo_fn_method_loginsession_two_factor_phone_options(
	void* ptr,
	RustCallStatus* out_status
);
...
void* uniffi_rustpushgo_fn_func_deregister_account(
	void* config,
	void* connection,
	void* users,
	RustCallStatus* out_status
...
uint16_t uniffi_rustpushgo_checksum_func_deregister_account(
	RustCallStatus* out_status
);
...
uint16_t uniffi_rustpushgo_checksum_method_client_lookup_targets_once(
	RustCallStatus* out_status
);
...
uint16_t uniffi_rustpushgo_checksum_method_client_send_leave_group(
	RustCallStatus* out_status
);
...
uint16_t uniffi_rustpushgo_checksum_method_client_send_multipart_message(
	RustCallStatus* out_status
);
...
uint16_t uniffi_rustpushgo_checksum_method_client_validate_targets_http(
	RustCallStatus* out_status
);
...
uint16_t uniffi_rustpushgo_checksum_method_loginsession_request_sms_2fa(
	RustCallStatus* out_status
);
...
uint16_t uniffi_rustpushgo_checksum_method_loginsession_two_factor_kind(
	RustCallStatus* out_status
);

uint16_t uniffi_rustpushgo_checksum_method_loginsession_two_factor_phone_options(
	RustCallStatus* out_status
);
