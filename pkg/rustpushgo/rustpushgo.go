...
func uniffiCheckChecksums() {
	...
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_rustpushgo_checksum_func_deregister_account(uniffiStatus)
		})
		if checksum != 64517 {
			// If this happens try cleaning and rebuilding your project
			panic("rustpushgo: uniffi_rustpushgo_checksum_func_deregister_account: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
	...
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_rustpushgo_checksum_method_client_lookup_targets_once(uniffiStatus)
		})
		if checksum != 17180 {
			// If this happens try cleaning and rebuilding your project
			panic("rustpushgo: uniffi_rustpushgo_checksum_method_client_lookup_targets_once: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
	...
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_rustpushgo_checksum_method_client_send_leave_group(uniffiStatus)
		})
		if checksum != 6681 {
			// If this happens try cleaning and rebuilding your project
			panic("rustpushgo: uniffi_rustpushgo_checksum_method_client_send_leave_group: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
	...
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_rustpushgo_checksum_method_client_send_multipart_message(uniffiStatus)
		})
		if checksum != 56693 {
			// If this happens try cleaning and rebuilding your project
			panic("rustpushgo: uniffi_rustpushgo_checksum_method_client_send_multipart_message: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
	...
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_rustpushgo_checksum_method_client_send_poll_vote(uniffiStatus)
		})
		if checksum != 1384 {
			// If this happens try cleaning and rebuilding your project
			panic("rustpushgo: uniffi_rustpushgo_checksum_method_client_send_poll_vote: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
	...
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_rustpushgo_checksum_method_client_validate_targets_http(uniffiStatus)
		})
		if checksum != 65386 {
			// If this happens try cleaning and rebuilding your project
			panic("rustpushgo: uniffi_rustpushgo_checksum_method_client_validate_targets_http: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
	...
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_rustpushgo_checksum_method_loginsession_request_sms_2fa(uniffiStatus)
		})
		if checksum != 8513 {
			// If this happens try cleaning and rebuilding your project
			panic("rustpushgo: uniffi_rustpushgo_checksum_method_loginsession_request_sms_2fa: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
	...
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_rustpushgo_checksum_method_loginsession_two_factor_kind(uniffiStatus)
		})
		if checksum != 20719 {
			// If this happens try cleaning and rebuilding your project
			panic("rustpushgo: uniffi_rustpushgo_checksum_method_loginsession_two_factor_kind: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_rustpushgo_checksum_method_loginsession_two_factor_phone_options(uniffiStatus)
		})
		if checksum != 17285 {
			// If this happens try cleaning and rebuilding your project
			panic("rustpushgo: uniffi_rustpushgo_checksum_method_loginsession_two_factor_phone_options: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
...
func (_self *Client) LookupTargetsOnce(targets []string, handle string) WrappedIdsLookupReport {
	_pointer := _self.ffiObject.incrementPointer("*Client")
	defer _self.ffiObject.decrementPointer()
	return uniffiRustCallAsyncWithResult(func(status *C.RustCallStatus) *C.void {
		// rustFutureFunc
		return (*C.void)(C.uniffi_rustpushgo_fn_method_client_lookup_targets_once(
		...
		FfiConverterTypeWrappedIdsLookupReportINSTANCE.Lift, func(rustFuture *C.void, status *C.RustCallStatus) {
			// freeFunc
			C.ffi_rustpushgo_rust_future_free_rust_buffer(unsafe.Pointer(rustFuture), status)
		})
}
...
func (_self *Client) SendAttachment(conversation WrappedConversation, data []byte, mime string, utiType string, filename string, handle string, replyGuid *string, replyPart *string, body *string, effect *string, isAudioMessage bool) (string, error) {
	_pointer := _self.ffiObject.incrementPointer("*Client")
	defer _self.ffiObject.decrementPointer()
	return uniffiRustCallAsyncWithErrorAndResult(
		FfiConverterTypeWrappedError{}, func(status *C.RustCallStatus) *C.void {
			...
			return (*C.void)(C.uniffi_rustpushgo_fn_method_client_send_attachment(
				_pointer, rustBufferToC(FfiConverterTypeWrappedConversationINSTANCE.Lower(conversation)), rustBufferToC(FfiConverterBytesINSTANCE.Lower(data)), rustBufferToC(FfiConverterStringINSTANCE.Lower(mime)), rustBufferToC(FfiConverterStringINSTANCE.Lower(utiType)), rustBufferToC(FfiConverterStringINSTANCE.Lower(filename)), rustBufferToC(FfiConverterStringINSTANCE.Lower(handle)), rustBufferToC(FfiConverterOptionalStringINSTANCE.Lower(replyGuid)), rustBufferToC(FfiConverterOptionalStringINSTANCE.Lower(replyPart)), rustBufferToC(FfiConverterOptionalStringINSTANCE.Lower(body)), rustBufferToC(FfiConverterOptionalStringINSTANCE.Lower(effect)), FfiConverterBoolINSTANCE.Lower(isAudioMessage),
				status,
			))
		},
		func(handle *C.void, ptr unsafe.Pointer, status *C.RustCallStatus) {
...
func (_self *Client) SendLeaveGroup(conversation WrappedConversation, groupVersion uint64, handle string) (string, error) {
	_pointer := _self.ffiObject.incrementPointer("*Client")
	defer _self.ffiObject.decrementPointer()
	return uniffiRustCallAsyncWithErrorAndResult(
		FfiConverterTypeWrappedError{}, func(status *C.RustCallStatus) *C.void {
			// rustFutureFunc
			return (*C.void)(C.uniffi_rustpushgo_fn_method_client_send_leave_group(
				_pointer, rustBufferToC(FfiConverterTypeWrappedConversationINSTANCE.Lower(conversation)), FfiConverterUint64INSTANCE.Lower(groupVersion), rustBufferToC(FfiConverterStringINSTANCE.Lower(handle)),
				status,
			))
		},
...
func (_self *Client) SendMarkUnread(conversation WrappedConversation, forUuid string, handle string) (string, error) {
	_pointer := _self.ffiObject.incrementPointer("*Client")
	defer _self.ffiObject.decrementPointer()
	return uniffiRustCallAsyncWithErrorAndResult(
		FfiConverterTypeWrappedError{}, func(status *C.RustCallStatus) *C.void {
			...
			return (*C.void)(C.uniffi_rustpushgo_fn_method_client_send_mark_unread(
				_pointer, rustBufferToC(FfiConverterTypeWrappedConversationINSTANCE.Lower(conversation)), rustBufferToC(FfiConverterStringINSTANCE.Lower(forUuid)), rustBufferToC(FfiConverterStringINSTANCE.Lower(handle)),
				status,
			))
		},
		func(handle *C.void, ptr unsafe.Pointer, status *C.RustCallStatus) {
...
func (_self *Client) SendMessage(conversation WrappedConversation, text string, html *string, subject *string, effect *string, handle string, replyGuid *string, replyPart *string, scheduledMs *uint64) (string, error) {
	_pointer := _self.ffiObject.incrementPointer("*Client")
	defer _self.ffiObject.decrementPointer()
	return uniffiRustCallAsyncWithErrorAndResult(
		FfiConverterTypeWrappedError{}, func(status *C.RustCallStatus) *C.void {
			...
			return (*C.void)(C.uniffi_rustpushgo_fn_method_client_send_message(
				_pointer, rustBufferToC(FfiConverterTypeWrappedConversationINSTANCE.Lower(conversation)), rustBufferToC(FfiConverterStringINSTANCE.Lower(text)), rustBufferToC(FfiConverterOptionalStringINSTANCE.Lower(html)), rustBufferToC(FfiConverterOptionalStringINSTANCE.Lower(subject)), rustBufferToC(FfiConverterOptionalStringINSTANCE.Lower(effect)), rustBufferToC(FfiConverterStringINSTANCE.Lower(handle)), rustBufferToC(FfiConverterOptionalStringINSTANCE.Lower(replyGuid)), rustBufferToC(FfiConverterOptionalStringINSTANCE.Lower(replyPart)), rustBufferToC(FfiConverterOptionalUint64INSTANCE.Lower(scheduledMs)),
				status,
			))
		},
		func(handle *C.void, ptr unsafe.Pointer, status *C.RustCallStatus) {
...
func (_self *Client) SendMultipartMessage(conversation WrappedConversation, parts []WrappedMultipartPart, handle string, subject *string, effect *string, replyGuid *string, replyPart *string) (string, error) {
	_pointer := _self.ffiObject.incrementPointer("*Client")
	defer _self.ffiObject.decrementPointer()
	return uniffiRustCallAsyncWithErrorAndResult(
		FfiConverterTypeWrappedError{}, func(status *C.RustCallStatus) *C.void {
			// rustFutureFunc
			return (*C.void)(C.uniffi_rustpushgo_fn_method_client_send_multipart_message(
				_pointer, rustBufferToC(FfiConverterTypeWrappedConversationINSTANCE.Lower(conversation)), rustBufferToC(FfiConverterSequenceTypeWrappedMultipartPartINSTANCE.Lower(parts)), rustBufferToC(FfiConverterStringINSTANCE.Lower(handle)), rustBufferToC(FfiConverterOptionalStringINSTANCE.Lower(subject)), rustBufferToC(FfiConverterOptionalStringINSTANCE.Lower(effect)), rustBufferToC(FfiConverterOptionalStringINSTANCE.Lower(replyGuid)), rustBufferToC(FfiConverterOptionalStringINSTANCE.Lower(replyPart)),
				status,
			))
		},
		func(handle *C.void, ptr unsafe.Pointer, status *C.RustCallStatus) {
...
func (_self *Client) SendNotifyAnyways(conversation WrappedConversation, forUuid string, handle string) (string, error) {
	_pointer := _self.ffiObject.incrementPointer("*Client")
	defer _self.ffiObject.decrementPointer()
	return uniffiRustCallAsyncWithErrorAndResult(
		FfiConverterTypeWrappedError{}, func(status *C.RustCallStatus) *C.void {
...
func (_self *Client) SendPollVote(conversation WrappedConversation, targetUuid string, sessionId string, pollResponseJson string, handle string) (string, error) {
	_pointer := _self.ffiObject.incrementPointer("*Client")
	defer _self.ffiObject.decrementPointer()
	return uniffiRustCallAsyncWithErrorAndResult(
		FfiConverterTypeWrappedError{}, func(status *C.RustCallStatus) *C.void {
			// rustFutureFunc
			return (*C.void)(C.uniffi_rustpushgo_fn_method_client_send_poll_vote(
				_pointer, rustBufferToC(FfiConverterTypeWrappedConversationINSTANCE.Lower(conversation)), rustBufferToC(FfiConverterStringINSTANCE.Lower(targetUuid)), rustBufferToC(FfiConverterStringINSTANCE.Lower(sessionId)), rustBufferToC(FfiConverterStringINSTANCE.Lower(pollResponseJson)), rustBufferToC(FfiConverterStringINSTANCE.Lower(handle)),
				status,
			))
		},
		func(handle *C.void, ptr unsafe.Pointer, status *C.RustCallStatus) {
	...
	return uniffiRustCallAsyncWithError(
		FfiConverterTypeWrappedError{}, func(status *C.RustCallStatus) *C.void {
			...
			return (*C.void)(C.uniffi_rustpushgo_fn_method_client_send_read_receipt(
				_pointer, rustBufferToC(FfiConverterTypeWrappedConversationINSTANCE.Lower(conversation)), rustBufferToC(FfiConverterStringINSTANCE.Lower(handle)), rustBufferToC(FfiConverterStringINSTANCE.Lower(forUuid)),
				status,
			))
		},
		func(handle *C.void, ptr unsafe.Pointer, status *C.RustCallStatus) {
...
func (_self *Client) SendTapback(conversation WrappedConversation, targetUuid string, targetPart uint64, targetText string, reaction uint32, emoji *string, remove bool, handle string) (string, error) {
	_pointer := _self.ffiObject.incrementPointer("*Client")
	defer _self.ffiObject.decrementPointer()
	return uniffiRustCallAsyncWithErrorAndResult(
		FfiConverterTypeWrappedError{}, func(status *C.RustCallStatus) *C.void {
			...
			return (*C.void)(C.uniffi_rustpushgo_fn_method_client_send_tapback(
				_pointer, rustBufferToC(FfiConverterTypeWrappedConversationINSTANCE.Lower(conversation)), rustBufferToC(FfiConverterStringINSTANCE.Lower(targetUuid)), FfiConverterUint64INSTANCE.Lower(targetPart), rustBufferToC(FfiConverterStringINSTANCE.Lower(targetText)), FfiConverterUint32INSTANCE.Lower(reaction), rustBufferToC(FfiConverterOptionalStringINSTANCE.Lower(emoji)), FfiConverterBoolINSTANCE.Lower(remove), rustBufferToC(FfiConverterStringINSTANCE.Lower(handle)),
				status,
			))
		},
		func(handle *C.void, ptr unsafe.Pointer, status *C.RustCallStatus) {
...
func (_self *Client) ValidateTargetsHttp(targets []string, handle string) ([]string, error) {
	_pointer := _self.ffiObject.incrementPointer("*Client")
	defer _self.ffiObject.decrementPointer()
	return uniffiRustCallAsyncWithErrorAndResult(
		FfiConverterTypeWrappedError{}, func(status *C.RustCallStatus) *C.void {
			// rustFutureFunc
			return (*C.void)(C.uniffi_rustpushgo_fn_method_client_validate_targets_http(
				_pointer, rustBufferToC(FfiConverterSequenceStringINSTANCE.Lower(targets)), rustBufferToC(FfiConverterStringINSTANCE.Lower(handle)),
				status,
			))
		},
...
func (_self *LoginSession) RequestSms2fa(phoneId uint32) (bool, error) {
	_pointer := _self.ffiObject.incrementPointer("*LoginSession")
	defer _self.ffiObject.decrementPointer()
	return uniffiRustCallAsyncWithErrorAndResult(
		FfiConverterTypeWrappedError{}, func(status *C.RustCallStatus) *C.void {
			// rustFutureFunc
			return (*C.void)(C.uniffi_rustpushgo_fn_method_loginsession_request_sms_2fa(
				_pointer, FfiConverterUint32INSTANCE.Lower(phoneId),
				status,
			))
		},
		func(handle *C.void, ptr unsafe.Pointer, status *C.RustCallStatus) {
...
func (_self *LoginSession) TwoFactorKind() string {
	_pointer := _self.ffiObject.incrementPointer("*LoginSession")
	defer _self.ffiObject.decrementPointer()
	return FfiConverterStringINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return rustBufferFromC(C.uniffi_rustpushgo_fn_method_loginsession_two_factor_kind(
			_pointer, _uniffiStatus))
	}))
}

func (_self *LoginSession) TwoFactorPhoneOptions() ([]TwoFactorPhoneOption, error) {
	_pointer := _self.ffiObject.incrementPointer("*LoginSession")
	defer _self.ffiObject.decrementPointer()
	return uniffiRustCallAsyncWithErrorAndResult(
		FfiConverterTypeWrappedError{}, func(status *C.RustCallStatus) *C.void {
			// rustFutureFunc
			return (*C.void)(C.uniffi_rustpushgo_fn_method_loginsession_two_factor_phone_options(
				_pointer,
				status,
			))
		},
		...
		FfiConverterSequenceTypeTwoFactorPhoneOptionINSTANCE.Lift, func(rustFuture *C.void, status *C.RustCallStatus) {
			// freeFunc
			C.ffi_rustpushgo_rust_future_free_rust_buffer(unsafe.Pointer(rustFuture), status)
		})
}
...
type TwoFactorPhoneOption struct {
	Id            uint32
	LastTwoDigits string
}

func (r *TwoFactorPhoneOption) Destroy() {
	FfiDestroyerUint32{}.Destroy(r.Id)
	FfiDestroyerString{}.Destroy(r.LastTwoDigits)
}

type FfiConverterTypeTwoFactorPhoneOption struct{}

var FfiConverterTypeTwoFactorPhoneOptionINSTANCE = FfiConverterTypeTwoFactorPhoneOption{}

func (c FfiConverterTypeTwoFactorPhoneOption) Lift(rb RustBufferI) TwoFactorPhoneOption {
	return LiftFromRustBuffer[TwoFactorPhoneOption](c, rb)
}

func (c FfiConverterTypeTwoFactorPhoneOption) Read(reader io.Reader) TwoFactorPhoneOption {
	return TwoFactorPhoneOption{
		FfiConverterUint32INSTANCE.Read(reader),
		FfiConverterStringINSTANCE.Read(reader),
	}
}

func (c FfiConverterTypeTwoFactorPhoneOption) Lower(value TwoFactorPhoneOption) RustBuffer {
	return LowerIntoRustBuffer[TwoFactorPhoneOption](c, value)
}

func (c FfiConverterTypeTwoFactorPhoneOption) Write(writer io.Writer, value TwoFactorPhoneOption) {
	FfiConverterUint32INSTANCE.Write(writer, value.Id)
	FfiConverterStringINSTANCE.Write(writer, value.LastTwoDigits)
}

type FfiDestroyerTypeTwoFactorPhoneOption struct{}

func (_ FfiDestroyerTypeTwoFactorPhoneOption) Destroy(value TwoFactorPhoneOption) {
	value.Destroy()
}
...
func (r *WrappedIdsLookupReport) Destroy() {
	FfiDestroyerSequenceTypeWrappedIdsLookupTarget{}.Destroy(r.Targets)
	FfiDestroyerOptionalString{}.Destroy(r.Error)
	FfiDestroyerBool{}.Destroy(r.Panicked)
	FfiDestroyerBool{}.Destroy(r.TimedOut)
	FfiDestroyerUint64{}.Destroy(r.Attempts)
}

type FfiConverterTypeWrappedIdsLookupReport struct{}

var FfiConverterTypeWrappedIdsLookupReportINSTANCE = FfiConverterTypeWrappedIdsLookupReport{}

func (c FfiConverterTypeWrappedIdsLookupReport) Lift(rb RustBufferI) WrappedIdsLookupReport {
	return LiftFromRustBuffer[WrappedIdsLookupReport](c, rb)
}

func (c FfiConverterTypeWrappedIdsLookupReport) Read(reader io.Reader) WrappedIdsLookupReport {
	return WrappedIdsLookupReport{
		FfiConverterSequenceTypeWrappedIdsLookupTargetINSTANCE.Read(reader),
		FfiConverterOptionalStringINSTANCE.Read(reader),
		FfiConverterBoolINSTANCE.Read(reader),
		FfiConverterBoolINSTANCE.Read(reader),
		FfiConverterUint64INSTANCE.Read(reader),
...
func (c FfiConverterTypeWrappedIdsLookupReport) Lower(value WrappedIdsLookupReport) RustBuffer {
	return LowerIntoRustBuffer[WrappedIdsLookupReport](c, value)
}

func (c FfiConverterTypeWrappedIdsLookupReport) Write(writer io.Writer, value WrappedIdsLookupReport) {
	FfiConverterSequenceTypeWrappedIdsLookupTargetINSTANCE.Write(writer, value.Targets)
	FfiConverterOptionalStringINSTANCE.Write(writer, value.Error)
	FfiConverterBoolINSTANCE.Write(writer, value.Panicked)
	FfiConverterBoolINSTANCE.Write(writer, value.TimedOut)
	FfiConverterUint64INSTANCE.Write(writer, value.Attempts)
}

type FfiDestroyerTypeWrappedIdsLookupReport struct{}

func (_ FfiDestroyerTypeWrappedIdsLookupReport) Destroy(value WrappedIdsLookupReport) {
	value.Destroy()
}

type WrappedIdsLookupTarget struct {
	Address                      string
	CacheEntryFresh              bool
	ResponseEntryReturned        bool
	IdentityCount                uint64
	CorrelationIdentifierPresent bool
}

func (r *WrappedIdsLookupTarget) Destroy() {
	FfiDestroyerString{}.Destroy(r.Address)
	FfiDestroyerBool{}.Destroy(r.CacheEntryFresh)
	FfiDestroyerBool{}.Destroy(r.ResponseEntryReturned)
	FfiDestroyerUint64{}.Destroy(r.IdentityCount)
	FfiDestroyerBool{}.Destroy(r.CorrelationIdentifierPresent)
}

type FfiConverterTypeWrappedIdsLookupTarget struct{}

var FfiConverterTypeWrappedIdsLookupTargetINSTANCE = FfiConverterTypeWrappedIdsLookupTarget{}

func (c FfiConverterTypeWrappedIdsLookupTarget) Lift(rb RustBufferI) WrappedIdsLookupTarget {
	return LiftFromRustBuffer[WrappedIdsLookupTarget](c, rb)
}

func (c FfiConverterTypeWrappedIdsLookupTarget) Read(reader io.Reader) WrappedIdsLookupTarget {
	return WrappedIdsLookupTarget{
		FfiConverterStringINSTANCE.Read(reader),
		FfiConverterBoolINSTANCE.Read(reader),
		FfiConverterBoolINSTANCE.Read(reader),
		FfiConverterUint64INSTANCE.Read(reader),
...
func (c FfiConverterTypeWrappedIdsLookupTarget) Lower(value WrappedIdsLookupTarget) RustBuffer {
	return LowerIntoRustBuffer[WrappedIdsLookupTarget](c, value)
}

func (c FfiConverterTypeWrappedIdsLookupTarget) Write(writer io.Writer, value WrappedIdsLookupTarget) {
	FfiConverterStringINSTANCE.Write(writer, value.Address)
	FfiConverterBoolINSTANCE.Write(writer, value.CacheEntryFresh)
	FfiConverterBoolINSTANCE.Write(writer, value.ResponseEntryReturned)
	FfiConverterUint64INSTANCE.Write(writer, value.IdentityCount)
	FfiConverterBoolINSTANCE.Write(writer, value.CorrelationIdentifierPresent)
}

type FfiDestroyerTypeWrappedIdsLookupTarget struct{}

func (_ FfiDestroyerTypeWrappedIdsLookupTarget) Destroy(value WrappedIdsLookupTarget) {
	value.Destroy()
}
...
func (r *WrappedMessage) Destroy() {
	...
	FfiDestroyerOptionalUint64{}.Destroy(r.ParticipantGroupVersion)
	FfiDestroyerSequenceTypeWrappedAttachment{}.Destroy(r.Attachments)
	FfiDestroyerOptionalString{}.Destroy(r.ReplyGuid)
	FfiDestroyerOptionalString{}.Destroy(r.ReplyPart)
	FfiDestroyerBool{}.Destroy(r.IsTyping)
	FfiDestroyerOptionalBool{}.Destroy(r.TypingActive)
	...
	FfiDestroyerBool{}.Destroy(r.VerificationFailed)
	FfiDestroyerOptionalString{}.Destroy(r.SenderGuid)
	...
	FfiDestroyerOptionalUint64{}.Destroy(r.GroupIconVersion)
...
func (c FfiConverterTypeWrappedMessage) Write(writer io.Writer, value WrappedMessage) {
	...
	FfiConverterOptionalUint64INSTANCE.Write(writer, value.ParticipantGroupVersion)
	...
	FfiConverterOptionalBoolINSTANCE.Write(writer, value.TypingActive)
	...
	FfiConverterBoolINSTANCE.Write(writer, value.VerificationFailed)
	FfiConverterOptionalStringINSTANCE.Write(writer, value.SenderGuid)
	...
	FfiConverterOptionalUint64INSTANCE.Write(writer, value.GroupIconVersion)
...
type WrappedMultipartPart struct {
	PartIndex uint64
	Text      *string
	Mention   *string
	Data      *[]byte
...
func (r *WrappedMultipartPart) Destroy() {
	FfiDestroyerUint64{}.Destroy(r.PartIndex)
	FfiDestroyerOptionalString{}.Destroy(r.Text)
	FfiDestroyerOptionalString{}.Destroy(r.Mention)
...
type FfiConverterTypeWrappedMultipartPart struct{}

var FfiConverterTypeWrappedMultipartPartINSTANCE = FfiConverterTypeWrappedMultipartPart{}

func (c FfiConverterTypeWrappedMultipartPart) Lift(rb RustBufferI) WrappedMultipartPart {
	return LiftFromRustBuffer[WrappedMultipartPart](c, rb)
}

func (c FfiConverterTypeWrappedMultipartPart) Read(reader io.Reader) WrappedMultipartPart {
	return WrappedMultipartPart{
		FfiConverterUint64INSTANCE.Read(reader),
		FfiConverterOptionalStringINSTANCE.Read(reader),
		FfiConverterOptionalStringINSTANCE.Read(reader),
		FfiConverterOptionalBytesINSTANCE.Read(reader),
...
func (c FfiConverterTypeWrappedMultipartPart) Lower(value WrappedMultipartPart) RustBuffer {
	return LowerIntoRustBuffer[WrappedMultipartPart](c, value)
}

func (c FfiConverterTypeWrappedMultipartPart) Write(writer io.Writer, value WrappedMultipartPart) {
	FfiConverterUint64INSTANCE.Write(writer, value.PartIndex)
	FfiConverterOptionalStringINSTANCE.Write(writer, value.Text)
	FfiConverterOptionalStringINSTANCE.Write(writer, value.Mention)
...
type FfiDestroyerTypeWrappedMultipartPart struct{}

func (_ FfiDestroyerTypeWrappedMultipartPart) Destroy(value WrappedMultipartPart) {
	value.Destroy()
}
...
type FfiConverterSequenceTypeTwoFactorPhoneOption struct{}

var FfiConverterSequenceTypeTwoFactorPhoneOptionINSTANCE = FfiConverterSequenceTypeTwoFactorPhoneOption{}

func (c FfiConverterSequenceTypeTwoFactorPhoneOption) Lift(rb RustBufferI) []TwoFactorPhoneOption {
	return LiftFromRustBuffer[[]TwoFactorPhoneOption](c, rb)
}

func (c FfiConverterSequenceTypeTwoFactorPhoneOption) Read(reader io.Reader) []TwoFactorPhoneOption {
	length := readInt32(reader)
	if length == 0 {
		return nil
	}
	result := make([]TwoFactorPhoneOption, 0, length)
	for i := int32(0); i < length; i++ {
		result = append(result, FfiConverterTypeTwoFactorPhoneOptionINSTANCE.Read(reader))
	}
	return result
}

func (c FfiConverterSequenceTypeTwoFactorPhoneOption) Lower(value []TwoFactorPhoneOption) RustBuffer {
	return LowerIntoRustBuffer[[]TwoFactorPhoneOption](c, value)
}

func (c FfiConverterSequenceTypeTwoFactorPhoneOption) Write(writer io.Writer, value []TwoFactorPhoneOption) {
	if len(value) > math.MaxInt32 {
		panic("[]TwoFactorPhoneOption is too large to fit into Int32")
	}

	writeInt32(writer, int32(len(value)))
	for _, item := range value {
		FfiConverterTypeTwoFactorPhoneOptionINSTANCE.Write(writer, item)
	}
}

type FfiDestroyerSequenceTypeTwoFactorPhoneOption struct{}

func (FfiDestroyerSequenceTypeTwoFactorPhoneOption) Destroy(sequence []TwoFactorPhoneOption) {
	for _, value := range sequence {
		FfiDestroyerTypeTwoFactorPhoneOption{}.Destroy(value)
	}
}
...
type FfiConverterSequenceTypeWrappedIdsLookupTarget struct{}

var FfiConverterSequenceTypeWrappedIdsLookupTargetINSTANCE = FfiConverterSequenceTypeWrappedIdsLookupTarget{}

func (c FfiConverterSequenceTypeWrappedIdsLookupTarget) Lift(rb RustBufferI) []WrappedIdsLookupTarget {
	return LiftFromRustBuffer[[]WrappedIdsLookupTarget](c, rb)
}

func (c FfiConverterSequenceTypeWrappedIdsLookupTarget) Read(reader io.Reader) []WrappedIdsLookupTarget {
	length := readInt32(reader)
	if length == 0 {
		return nil
	}
	result := make([]WrappedIdsLookupTarget, 0, length)
	for i := int32(0); i < length; i++ {
		result = append(result, FfiConverterTypeWrappedIdsLookupTargetINSTANCE.Read(reader))
	}
	return result
}

func (c FfiConverterSequenceTypeWrappedIdsLookupTarget) Lower(value []WrappedIdsLookupTarget) RustBuffer {
	return LowerIntoRustBuffer[[]WrappedIdsLookupTarget](c, value)
}

func (c FfiConverterSequenceTypeWrappedIdsLookupTarget) Write(writer io.Writer, value []WrappedIdsLookupTarget) {
	if len(value) > math.MaxInt32 {
		panic("[]WrappedIdsLookupTarget is too large to fit into Int32")
	}

	writeInt32(writer, int32(len(value)))
	for _, item := range value {
		FfiConverterTypeWrappedIdsLookupTargetINSTANCE.Write(writer, item)
	}
}

type FfiDestroyerSequenceTypeWrappedIdsLookupTarget struct{}

func (FfiDestroyerSequenceTypeWrappedIdsLookupTarget) Destroy(sequence []WrappedIdsLookupTarget) {
	for _, value := range sequence {
		FfiDestroyerTypeWrappedIdsLookupTarget{}.Destroy(value)
	}
}
...
type FfiConverterSequenceTypeWrappedMultipartPart struct{}

var FfiConverterSequenceTypeWrappedMultipartPartINSTANCE = FfiConverterSequenceTypeWrappedMultipartPart{}

func (c FfiConverterSequenceTypeWrappedMultipartPart) Lift(rb RustBufferI) []WrappedMultipartPart {
	return LiftFromRustBuffer[[]WrappedMultipartPart](c, rb)
}

func (c FfiConverterSequenceTypeWrappedMultipartPart) Read(reader io.Reader) []WrappedMultipartPart {
	length := readInt32(reader)
	if length == 0 {
		return nil
	}
	result := make([]WrappedMultipartPart, 0, length)
	for i := int32(0); i < length; i++ {
		result = append(result, FfiConverterTypeWrappedMultipartPartINSTANCE.Read(reader))
	}
	return result
}

func (c FfiConverterSequenceTypeWrappedMultipartPart) Lower(value []WrappedMultipartPart) RustBuffer {
	return LowerIntoRustBuffer[[]WrappedMultipartPart](c, value)
}

func (c FfiConverterSequenceTypeWrappedMultipartPart) Write(writer io.Writer, value []WrappedMultipartPart) {
	if len(value) > math.MaxInt32 {
		panic("[]WrappedMultipartPart is too large to fit into Int32")
	}

	writeInt32(writer, int32(len(value)))
	for _, item := range value {
		FfiConverterTypeWrappedMultipartPartINSTANCE.Write(writer, item)
	}
}

type FfiDestroyerSequenceTypeWrappedMultipartPart struct{}

func (FfiDestroyerSequenceTypeWrappedMultipartPart) Destroy(sequence []WrappedMultipartPart) {
	for _, value := range sequence {
		FfiDestroyerTypeWrappedMultipartPart{}.Destroy(value)
	}
}
...
func DeregisterAccount(config *WrappedOsConfig, connection *WrappedApsConnection, users *WrappedIdsUsers) error {
	return uniffiRustCallAsyncWithError(
		FfiConverterTypeWrappedError{}, func(status *C.RustCallStatus) *C.void {
			// rustFutureFunc
			return (*C.void)(C.uniffi_rustpushgo_fn_func_deregister_account(FfiConverterWrappedOSConfigINSTANCE.Lower(config), FfiConverterWrappedAPSConnectionINSTANCE.Lower(connection), FfiConverterWrappedIDSUsersINSTANCE.Lower(users),
				status,
			))
		},
		func(handle *C.void, ptr unsafe.Pointer, status *C.RustCallStatus) {
